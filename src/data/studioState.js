export const studioState = {
  ...
  roleAgents: {
    teacher: {
      name: '教师主智能体',
      role: 'Educator Agent',
      summary: '已装配课程案例讲解、成果批注、过程回放与课堂演示能力。',
    ...
    student: {
      name: '学生主智能体',
      role: 'Student Agent',
      summary: '已装配任务分解、学习提示、成果对比与步骤回放能力。',
    ...
    designer: {
      name: '设计主智能体',
      role: 'Designer Agent',
      summary: '已装配拓扑建模、GIS 校核、方案比选、审查与交付能力。',
      chips: ['拓扑图', 'GIS', '校核'],
    ...
    researcher: {
      name: '科研主智能体',
      role: 'Research Agent',
      summary: '已装配实验追踪、参数对比、证据组织与论文素材抽取能力。',
      chips: ['实验记录', '参数对比', '证据链'],
    ...
    dispatcher: {
      ...
      summary: '已装配实时监测、运行建议、告警处置、回放与应急调度能力。',
      chips: ['实时监控', '告警', '回放'],
    ...
    operator: {
      name: '运行主智能体',
      role: 'Operator Agent',
      summary: '已装配值守日志、巡检闭环、工单联动与异常处置能力。',
      chips: ['值守日志', '巡检', '异常处置'],
    ...
    manager: {
      name: '管理主智能体',
      role: 'Manager Agent',
      summary: '已装配全局态势、关键指标、风险摘要与交付签发能力。',
      chips: ['经营指标', '风险摘要', '签发'],
