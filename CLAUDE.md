...
3. `READ gitnexus://repo/HydroDesk/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/HydroDesk/context` | Codebase overview, check index freshness |
| `gitnexus://repo/HydroDesk/clusters` | All functional areas |
| `gitnexus://repo/HydroDesk/processes` | All execution flows |
| `gitnexus://repo/HydroDesk/process/{name}` | Step-by-step execution trace |
